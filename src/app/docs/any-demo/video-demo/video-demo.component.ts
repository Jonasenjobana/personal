...
@Component({
  selector: 'video-demo',
  imports: [SlVideoplayerComponent],
...
export class VideoDemoComponent {
  ...
  idx: number = 0;
  url: string = 'http://183.63.55.74:10000/sms/34020000002020000001/hls/34020000001110000031_34020000001320002009/34020000001110000031_34020000001320002009_live.m3u8'
